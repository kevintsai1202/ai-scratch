...
- 防止重複加分：碰撞加分後用旗標變數（如「_已接到」=1），偵測條件加上「且 _已接到=0」，避免同一次碰撞重複觸發
